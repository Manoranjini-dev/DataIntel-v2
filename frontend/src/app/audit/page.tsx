...
export default function AuditPage() {
  ...
  async function loadLogs() {
    ...
    try {
      ...
      const r = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3001/api'}/audit?${qs}`,
        { credentials: 'include' }
      );
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">All activity for <span className="text-foreground font-medium"></span></p>
          </div>
        </div>
